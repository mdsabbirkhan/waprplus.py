...
print ("--------")
print ("[+] THIS SCRIPT CODDED BY Team Matrix") 
print ("[-] Github: https://github.com/Teammatrixx") 
print ("[-] TELEGRAM: Teammatrixx")
print ("--------")
...
while True:
	os.system('cls' if os.name == 'nt' else 'clear')
	print("")
	print("                  WARP-PLUS-CLOUDFLARE (script)" + " By Team Matrix")
	print("")
